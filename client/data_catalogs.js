...
const NATURAL_MINES = [
  ...
  { id:"mine_timber", name:"Serraria & Silvicultura Florestal", emoji:"🪵", resourceId:"timber", resourceName:"Madeira / Toras", cost:28000, unitCost:12.00, quality:60, dailyYield:650, desc:"Instalação de extração e corte de toras nativas em reservas florestais." },
...
const FARM_TYPES = [
  ...
  { id:"farm_timber", name:"Silvicultura / Pínus & Eucalipto", emoji:"🪵", cropId:"timber", cropName:"Madeira / Toras", cost:26000, unitCost:10.00, quality:65, dailyYield:550, desc:"Florestamento comercial de madeira cultivada para serrarias, móveis e celulose." },
...
"perCapitaDailyDemand": 0.0008
  ...
  // ── INSUMOS INDUSTRIAIS & MANUFATURA INTERMEDIÁRIA ──
  "flour": {
"id": "flour",
"name": "Farinha Refinada",
...
"perCapitaDailyDemand": 0
  ...
  "chemical_minerals": {
"id": "chemical_minerals",
"name": "Minerais Químicos",
"category": "Recursos Naturais",
"standardPrice": 24.0,
"baseCost": 14.0,
"rdBaseCost": 3800,
...
const RD_CATEGORIES = {
  ...
  "Insumos Industriais": { baseCost: 4000,  icon: "⚙️", label: "Insumos & Manufatura" },
  "Agronegócio":         { baseCost: 2200,  icon: "🚜", label: "Agronegócio & Pecuária" },
